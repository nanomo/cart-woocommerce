...
const payment_mercado_pago_ticket = {
  initScreen: function () {
      ...
      if (offi === 0) {
        var checkbox_offline_prepend = '<div class="all_checkbox">\
          <label for="checkmeoff" id="mp_input_payments" style="margin-bottom: 37px !important;">\
            <input type="checkbox" name="checkmeoff" id="checkmeoff" ' + offlineChecked + ' onclick="this.completeOfflineCheckbox()">\
...
window.addEventListener('load', function () {
  payment_mercado_pago_ticket.initScreen();
});
