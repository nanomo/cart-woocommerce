...
class WC_WooMercadoPago_Custom_Gateway extends WC_WooMercadoPago_Payment_Abstract {
	...
	public function get_form_mp_fields( $label ) {
		if ( is_admin() && $this->is_manage_section() && ( WC_WooMercadoPago_Helper_Current_Url::validate_page('mercadopago-settings') || WC_WooMercadoPago_Helper_Current_Url::validate_section('woo-mercado') ) ) {
	...
	public function field_checkout_custom_wallet_button_title() {
		add_action( 'mp_after_toggle_switch', array($this, 'wallet_button_preview') );
		return array(
	...
	public function wallet_button_preview() {
		remove_action( 'mp_after_toggle_switch', 'wallet_button_preview' );
		wc_get_template(
