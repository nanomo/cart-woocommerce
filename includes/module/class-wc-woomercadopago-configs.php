	...
	public function set_payment_gateway( $methods = null ) {
		...
		if ( ! empty( $wp ) && isset( $wp->query_vars['wc-api'] ) ) {
			...
			if ( ! empty( $api_request ) && in_array(
				...
				array(
					'wc_woomercadopago_basic_gateway', 'wc_woomercadopago_custom_gateway', 'wc_woomercadopago_ticket_gateway',
					'wc_woomercadopago_basicgateway', 'wc_woomercadopago_customgateway', 'wc_woomercadopago_ticketgateway',
				),
				true
			) ) {
