...
<div class='mp-checkout-container'>
	<div class="mp-checkout-pro-container">
		<div class="mp-checkout-pro-content">
			...
			<checkout-benefits title="<?php echo esc_html_e('Pay faster with Mercado Pago', 'woocommerce-mercadopago'); ?>" items='[
			...
			]' list-style-type-src="<?php echo esc_html($list_style_type_src); ?>" list-style-type-alt="<?php echo esc_html_e('List style type blue check', 'woocommerce-mercadopago'); ?>">
			</checkout-benefits>
