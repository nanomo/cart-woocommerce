	...
	<div class="mp-row-checkout">
		...
		<?php if ( $coupon_mode == 'yes' ) : ?>
			...
			<div class="frame-tarjetas mp-text-justify">
				<p class="mp-subtitle-ticket-checkout"><?php echo __( 'Enter your discount coupon', 'woocommerce-mercadopago' ); ?></p>

				<div class="mp-row-checkout mp-pt-10">
					<div class="mp-col-md-9 mp-pr-15">
						<input type="text" class="mp-form-control" id="couponCodeTicket" name="mercadopago_ticket[coupon_code]" autocomplete="off" maxlength="24" placeholder="<?php echo __( 'Enter your coupon', 'woocommerce-mercadopago' ); ?>" />
					</div>
					...
					<span class="mp-erro_febraban" id="mpCouponErrorTicket"><?php echo __( 'The code you entered is incorrect', 'woocommerce-mercadopago' ); ?></span>
				</div>
			</div>
		</div>
		<?php endif; ?>
		...
		<div class="mp-col-md-12">
			<div class="frame-tarjetas">
				<div id="mercadopago-form-ticket">
					...
					<div id="form-ticket">
						...
						<div class="mp-row-checkout mp-pt-10">
							<div class="mp-col-md-4 mp-pr-15" id="mp_box_firstname">
								...
								<input type="text" class="mp-form-control" value="<?php echo $febraban['firstname']; ?>" id="mp_firstname" data-checkout="mp_firstname" name="mercadopago_ticket[firstname]">
							...
							<div class="mp-col-md-4 mp-pr-15" id="mp_box_lastname">
								...
								<input type="text" class="mp-form-control" value="<?php echo $febraban['lastname']; ?>" id="mp_lastname" data-checkout="mp_lastname" name="mercadopago_ticket[lastname]">
							...
							<div class="mp-col-md-4" id="box-docnumber">
								...
								<input type="text" class="mp-form-control" value="<?php echo $febraban['docNumber']; ?>" id="mp_doc_number" data-checkout="mp_doc_number" name="mercadopago_ticket[docNumber]" onkeyup="mpMaskInput(this, mpCpf);" maxlength="14">
								<span class="mp-erro_febraban" data-main="#mp_doc_number"><?php echo esc_html__( 'You must provide your document number', 'woocommerce-mercadopago' ); ?></span>
								<span class="mp_error_docnumber" id="mp_error_docnumber"><?php echo esc_html__( 'Invalid Document Number', 'woocommerce-mercadopago' ); ?></span>
							</div>
						</div>
						...
						<div class="mp-row-checkout mp-pt-10">
							<div class="mp-col-md-8 mp-pr-15" id="box-firstname">
								...
								<input type="text" value="<?php echo $febraban['address']; ?>" class="mp-form-control" id="mp_address" data-checkout="mp_address" name="mercadopago_ticket[address]">
							...
							<div class="mp-col-md-4">
								...
								<input type="text" value="<?php echo $febraban['number']; ?>" class="mp-form-control" id="mp_number" data-checkout="mp_number" name="mercadopago_ticket[number]" onkeyup="mpMaskInput(this, mpTicketInteger);">
						...
						<div class="mp-row-checkout mp-pt-10">
							<div class="mp-col-md-4 mp-pr-15">
								...
								<input type="text" value="<?php echo $febraban['city']; ?>" class="mp-form-control" id="mp_city" data-checkout="mp_city" name="mercadopago_ticket[city]">
							...
							<div class="mp-col-md-4 mp-pr-15">
								...
								<select name="mercadopago_ticket[state]" id="mp_state" data-checkout="mp_state" class="mp-form-control mp-pointer">
									...
									<option value="AC"
									<?php
									if ( $febraban['state'] == 'AC' ) {
										echo 'selected="selected"'; }
									?>
									>Acre</option>
									<option value="AL"
									<?php
									if ( $febraban['state'] == 'AL' ) {
										echo 'selected="selected"'; }
									?>
									>Alagoas</option>
									<option value="AP"
									<?php
									if ( $febraban['state'] == 'AP' ) {
										echo 'selected="selected"'; }
									?>
									>Amapá</option>
									<option value="AM"
									<?php
									if ( $febraban['state'] == 'AM' ) {
										echo 'selected="selected"'; }
									?>
									>Amazonas</option>
									<option value="BA"
									<?php
									if ( $febraban['state'] == 'BA' ) {
										echo 'selected="selected"'; }
									?>
									>Bahia</option>
									<option value="CE"
									<?php
									if ( $febraban['state'] == 'CE' ) {
										echo 'selected="selected"'; }
									?>
									>Ceará</option>
									<option value="DF"
									<?php
									if ( $febraban['state'] == 'DF' ) {
										echo 'selected="selected"'; }
									?>
									>Distrito Federal</option>
									<option value="ES"
									<?php
									if ( $febraban['state'] == 'ES' ) {
										echo 'selected="selected"'; }
									?>
									>Espírito Santo</option>
									<option value="GO"
									<?php
									if ( $febraban['state'] == 'GO' ) {
										echo 'selected="selected"'; }
									?>
									>Goiás</option>
									<option value="MA"
									<?php
									if ( $febraban['state'] == 'MA' ) {
										echo 'selected="selected"'; }
									?>
									>Maranhão</option>
									<option value="MT"
									<?php
									if ( $febraban['state'] == 'MT' ) {
										echo 'selected="selected"'; }
									?>
									>Mato Grosso</option>
									<option value="MS"
									<?php
									if ( $febraban['state'] == 'MS' ) {
										echo 'selected="selected"'; }
									?>
									>Mato Grosso do Sul</option>
									<option value="MG"
									<?php
									if ( $febraban['state'] == 'MG' ) {
										echo 'selected="selected"'; }
									?>
									>Minas Gerais</option>
									<option value="PA"
									<?php
									if ( $febraban['state'] == 'PA' ) {
										echo 'selected="selected"'; }
									?>
									>Pará</option>
									<option value="PB"
									<?php
									if ( $febraban['state'] == 'PB' ) {
										echo 'selected="selected"'; }
									?>
									>Paraíba</option>
									<option value="PR"
									<?php
									if ( $febraban['state'] == 'PR' ) {
										echo 'selected="selected"'; }
									?>
									>Paraná</option>
									<option value="PE"
									<?php
									if ( $febraban['state'] == 'PE' ) {
										echo 'selected="selected"'; }
									?>
									>Pernambuco</option>
									<option value="PI"
									<?php
									if ( $febraban['state'] == 'PI' ) {
										echo 'selected="selected"'; }
									?>
									>Piauí</option>
									<option value="RJ"
									<?php
									if ( $febraban['state'] == 'RJ' ) {
										echo 'selected="selected"'; }
									?>
									>Rio de Janeiro</option>
									<option value="RN"
									<?php
									if ( $febraban['state'] == 'RN' ) {
										echo 'selected="selected"'; }
									?>
									>Rio Grande do Norte</option>
									<option value="RS"
									<?php
									if ( $febraban['state'] == 'RS' ) {
										echo 'selected="selected"'; }
									?>
									>Rio Grande do Sul</option>
									<option value="RO"
									<?php
									if ( $febraban['state'] == 'RO' ) {
										echo 'selected="selected"'; }
									?>
									>Rondônia</option>
									<option value="RA"
									<?php
									if ( $febraban['state'] == 'RA' ) {
										echo 'selected="selected"'; }
									?>
									>Roraima</option>
									<option value="SC"
									<?php
									if ( $febraban['state'] == 'SC' ) {
										echo 'selected="selected"'; }
									?>
									>Santa Catarina</option>
									<option value="SP"
									<?php
									if ( $febraban['state'] == 'SP' ) {
										echo 'selected="selected"'; }
									?>
									>São Paulo</option>
									<option value="SE"
									<?php
									if ( $febraban['state'] == 'SE' ) {
										echo 'selected="selected"'; }
									?>
									>Sergipe</option>
									<option value="TO"
									<?php
									if ( $febraban['state'] == 'TO' ) {
										echo 'selected="selected"'; }
									?>
									>Tocantins</option>
								</select>
							...
							<div class="mp-col-md-4">
								...
								<input type="text" value="<?php echo $febraban['zipcode']; ?>" id="mp_zipcode" data-checkout="mp_zipcode" class="mp-form-control" name="mercadopago_ticket[zipcode]" maxlength="9" onkeyup="mpMaskInput(this, mpCep);">
					...
					<div class="mp-col-md-12 <?php echo ( $site_id == 'MLB' ) ? 'mp-pt-20' : ''; ?>">
						<div class="frame-tarjetas">
							<p class="mp-subtitle-ticket-checkout"><?php echo __( 'Select the issuer with whom you want to process the payment', 'woocommerce-mercadopago' ); ?></p>
							...
							<div class="mp-row-checkout mp-pt-10">
								...
								<div id="frameTicket" class="mp-col-md-6 mp-pb-15 mp-min-hg">
										<div id="paymentMethodIdTicket" class="mp-ticket-payments">
											<label for="<?php echo $payment['id']; ?>" class="mp-label-form mp-pointer">
												<input type="radio" class="mp-form-control-check" name="mercadopago_ticket[paymentMethodId]" id="<?php echo $payment['id']; ?>" value="<?php echo $payment['id']; ?>"
																																							<?php
																																							if ( $atFirst ) :
																																								?>
													 checked="checked" <?php endif; ?> />
												<img src="<?php echo $payment['secure_thumbnail']; ?>" class="mp-img-ticket" alt="<?php echo $payment['name']; ?>" />
												<span class="mp-ticket-name"><?php echo $payment['name']; ?></span>
											</label>
										</div>
										<?php $atFirst = false; ?>
									</div>
